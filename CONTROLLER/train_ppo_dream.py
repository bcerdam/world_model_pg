...
class DreamEnv(gym.Env):
    def __init__(self, rnn_path, data_path, device, temperature=1.15):
        ...
        # --- MODIFIED: Load the .npz file correctly ---
        print(f"Loading dataset from {data_path}...")
        with np.load(data_path, allow_pickle=True) as data:
            # These are arrays of arrays (object dtype)
    ...
    def reset(self, seed=None, options=None):
        ...
        # --- MODIFIED: Sample random rollout, then random frame ---
        ...
        # Get mu/logvar for that specific frame
...
if __name__ == "__main__":
    ...
    parser.add_argument('--rnn_path', type=str,
                        default='rnn_checkpoints/rnn_epoch_3.pth')
