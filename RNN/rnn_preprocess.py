...
if __name__ == "__main__":
    ...
    parser.add_argument('--vae_model', type=str, default='model_checkpoints/vae_2_checkpoints/vae_epoch_20.pth', help='Path to trained VAE model')
    ...
    parser.add_argument('--max_rollouts', type=int, default=500, help='Max rollouts to process')
